...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Replay historical Frigate events via MQTT for testing.")
    parser.add_argument("--frigate-url", default=os.environ.get("FRIGATE_URL", "http://192.168.1.XX:5000"), help="Frigate API base URL")
    parser.add_argument("--mqtt-broker", default=os.environ.get("MQTT_BROKER", "192.168.1.XX"), help="MQTT Broker IP/Host")
